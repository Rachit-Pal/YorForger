...
buttons = [
    [
        InlineKeyboardButton(
            text="➕ Add Me To Your Groups ➕", url=f"t.me/{BOT_USERNAME}?startgroup=true"
        ),
    ],
    [
        ...
        update.effective_message.reply_animation(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📶 Network", url=f"https://t.me/StrawHatNetwork"
                        ),
                        InlineKeyboardButton(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}",
                "[YOUR YOR IS BACK](https://telegra.ph/file/697f47b640bbc28201ed2.mp4)",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
