...
from YorForger import dispatcher, telethn
from YorForger.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("YorForger.modules." +
                                                  text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("YorForger.modules.", 1)[1]
