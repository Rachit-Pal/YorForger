...
from YorForger.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                    OWNER_IMG,
                    caption="Huh! My master join here!\n hello! Legend ✋",
                    reply_to_message_id=reply,
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A Yonko just joined the chat!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! A Fleet Admiral just joined! Stay Alert, pirates!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! An Admiral just joined! Stay on guards!.",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Oof! A captain from someone's crew just joined!", reply_to_message_id=reply
                )
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A vice-captain from someone's crew just joined!", reply_to_message_id=reply
                )
                continue
