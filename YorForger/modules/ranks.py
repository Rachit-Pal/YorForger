...
from YorForger.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "YorForger/elevated_users.json")
...
BRANK_IMG = "https://telegra.ph/file/a701e9d84627a4c77ba2a.jpg"
...
def supportlist(update: Update, context: CallbackContext):
    ...
    for each_user in DEMONS:
        ...
        try:
            ...
            pass
    update.effective_message.reply_photo(
        BRANK_IMG, caption=reply, parse_mode=ParseMode.HTML
    )


ARANK_IMG = "https://telegra.ph/file/02721e56b138bad4a6695.jpg"
...
def sudolist(update: Update, context: CallbackContext):
    ...
    for each_user in true_sudo:
        ...
        try:
            ...
            pass
    update.effective_message.reply_photo(
        ARANK_IMG, caption=reply, parse_mode=ParseMode.HTML
    )
...
UNSUPPORT_HANDLER = CommandHandler(("removesupport", "removebrank"), removesupport)
UNTIGER_HANDLER = CommandHandler(("removetiger", "removecrank"), removetiger)
UNWHITELIST_HANDLER = CommandHandler(
    ("removewhitelist", "removedrank"), removewhitelist
)

WHITELISTLIST_HANDLER = CommandHandler(["whitelistlist", "dranks"], whitelistlist)
