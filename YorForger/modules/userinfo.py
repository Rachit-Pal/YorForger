...
from YorForger import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from YorForger.modules.sql.afk_sql import is_afk, check_afk_status
...
from YorForger import telethn as tbot , TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/StrawHatUpdates/9">What is Ranks</a>]'.format(
            bot.username)
